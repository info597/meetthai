                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: const Color(0xFFFFD978)
                              .withValues(alpha: 0.55 * auraOpacityValue),
                          width: size * 0.018,
                        ),
                        boxShadow: [
                          BoxShadow(
                            color: const Color(0xFFFFD978)
                                .withValues(alpha: 0.18 * auraOpacityValue),
                            blurRadius: size * 0.10,
                            spreadRadius: size * 0.01,
                          ),
                          BoxShadow(
                            color: const Color(0xFFFFE7A8)
                                .withValues(alpha: 0.12 * auraOpacityValue),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: const Color(0xFFFFD36E)
                                .withValues(alpha: 0.18 * goldGlowValue),
                            blurRadius: size * 0.08,
                            spreadRadius: size * 0.01,
                          ),
                          BoxShadow(
                            color: const Color(0xFFFFE7A8)
                                .withValues(alpha: 0.16 * goldGlowValue),
